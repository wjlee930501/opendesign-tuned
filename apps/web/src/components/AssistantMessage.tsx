  ...
  return (
    <div className="assistant-footer" data-unfinished={hasUnfinishedTodos ? 'true' : 'false'}>
      ...
      <span className="assistant-label">
        {assistantFooterLabel({ streaming, runStatus, hasUnfinishedTodos }, t)}
      </span>
...
function assistantFooterLabel(
  ...
  if (streaming) return t('assistant.workingLabel');
  if (runStatus === 'failed') return t('assistant.failedLabel');
  if (runStatus === 'canceled') return t('assistant.canceledLabel');
  if (hasUnfinishedTodos) return t('assistant.unfinishedLabel');
  return t('assistant.doneLabel');
}
